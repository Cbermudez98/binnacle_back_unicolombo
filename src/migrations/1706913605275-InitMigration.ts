...
export class InitMigration1706913605275 implements MigrationInterface {
    name = 'InitMigration1706913605275'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`book_views\` ADD CONSTRAINT \`FK_91d2810192032c465190d68f809\` FOREIGN KEY (\`user_id\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`book_views\` ADD CONSTRAINT \`FK_2637bcf8329aa862611d240f43a\` FOREIGN KEY (\`book_id\`) REFERENCES \`books\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
